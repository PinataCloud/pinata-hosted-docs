...
* The [Pinning Services API endpoint for listing content](https://ipfs.github.io/pinning-services-api-spec/) has a rate limit of 30 requests per minute
...
<TabItem label="Dedicated Gateways">
