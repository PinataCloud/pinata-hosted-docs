...
<ApiEndpoint route="pinning/pinFileToIPFS" method="POST" />

<ApiRequestInfo>
  <ApiDetails slot="header" keys="Authorization" type="string" value="Your method of authorization, e.g. Bearer PINATA_API_KEY_JWT" />
  <ApiDetails slot="body" keys="file" type="readable stream" value="File to be uploaded via multipart/form-data." required="true" />
  <ApiDetails slot="body" keys="pinataOptions" type="object" value="Optional object for things like CID version, see pinning." />
  <ApiDetails slot="body" keys="pinataMetadata" type="object" value="Optional object for Pinata specific metdata, such as 'name'. See pinning." />
  <Tabs slot="responses">
